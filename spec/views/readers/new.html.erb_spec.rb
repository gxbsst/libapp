...
describe "readers/new.html.erb" do
  ...
  before :each do
    ...
    reader.stub(:email).and_return("some email")
  ...
  it "has reader_email field" do
    expect(rendered).to have_selector('input#reader_email')
  end

  it "has reader_password field" do
    expect(rendered).to have_selector('input#reader_password')
  end

  it "has reader_password_confirmation field" do
    expect(rendered).to have_selector('input#reader_password_confirmation')
  end
